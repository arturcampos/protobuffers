...
type UserServiceClient interface {
	...
	AddUserStreamBidirectional(ctx context.Context, opts ...grpc.CallOption) (UserService_AddUserStreamBidirectionalClient, error)
}
...
func (c *userServiceClient) AddUserStreamBidirectional(ctx context.Context, opts ...grpc.CallOption) (UserService_AddUserStreamBidirectionalClient, error) {
	stream, err := c.cc.NewStream(ctx, &UserService_ServiceDesc.Streams[2], "/pb.UserService/AddUserStreamBidirectional", opts...)
	if err != nil {
		return nil, err
	}
	x := &userServiceAddUserStreamBidirectionalClient{stream}
	return x, nil
}

type UserService_AddUserStreamBidirectionalClient interface {
	Send(*User) error
	Recv() (*UserResultStream, error)
	grpc.ClientStream
}

type userServiceAddUserStreamBidirectionalClient struct {
	grpc.ClientStream
}

func (x *userServiceAddUserStreamBidirectionalClient) Send(m *User) error {
	return x.ClientStream.SendMsg(m)
}

func (x *userServiceAddUserStreamBidirectionalClient) Recv() (*UserResultStream, error) {
	m := new(UserResultStream)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type UserServiceServer interface {
	...
	AddUserStreamBidirectional(UserService_AddUserStreamBidirectionalServer) error
...
func (UnimplementedUserServiceServer) AddUserStreamBidirectional(UserService_AddUserStreamBidirectionalServer) error {
	return status.Errorf(codes.Unimplemented, "method AddUserStreamBidirectional not implemented")
}
...
func _UserService_AddUserStreamBidirectional_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(UserServiceServer).AddUserStreamBidirectional(&userServiceAddUserStreamBidirectionalServer{stream})
}

type UserService_AddUserStreamBidirectionalServer interface {
	Send(*UserResultStream) error
	Recv() (*User, error)
	grpc.ServerStream
}

type userServiceAddUserStreamBidirectionalServer struct {
	grpc.ServerStream
}

func (x *userServiceAddUserStreamBidirectionalServer) Send(m *UserResultStream) error {
	return x.ServerStream.SendMsg(m)
}

func (x *userServiceAddUserStreamBidirectionalServer) Recv() (*User, error) {
	m := new(User)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "AddUserStreamBidirectional",
			Handler:       _UserService_AddUserStreamBidirectional_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
